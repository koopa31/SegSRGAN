...
def download_directory(url, target):
    ...
    if response.info()._default_type == 'text/html':
...
download_directory('https://github.com/koopa31/SegSRGAN/tree/develop/deepBrain-master/SegSRGAN/weights', '/home/clement')